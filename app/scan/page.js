                                      ...
                                      <div className="flex items-center space-x-1">
                                        ...
                                        <div className="flex items-center">
                                          ...
                                          <span className={`text-xs mx-1 transition-all duration-200 ${
                                            Math.abs(orientation.gamma) > gammaTolerance ? 'font-bold' : ''
                                        ...
                                        <div className="flex items-center">
                                          {Math.abs((orientation.beta || 0) - betaTarget) > betaTolerance && (
                                            <div className={`w-0 h-0 border-l-4 border-r-4 border-b-6 animate-pulse ${
                                              (orientation.beta || 0) > betaTarget ? 'border-l-transparent border-r-white border-b-white' : 'border-l-white border-r-transparent border-b-white rotate-180'
                                            }`} />
                                          )}
                                          <span className={`text-xs mx-1 transition-all duration-200 ${
                                            Math.abs((orientation.beta || 0) - betaTarget) > betaTolerance ? 'font-bold' : ''
                                          }`}>{Math.abs((orientation.beta || 0) - betaTarget).toFixed(0)}°</span>
                                        </div>
                                      </div>
                                    </div>
                                  )}
